...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Barbeque App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Barbeque App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Barbeque App Login', user : req.user }); 
}); 
